...
- Playwright browser flows cover login/session creation, location reveal, celebrity reveal, custom text reveal, console readiness surfaces, and ended-session lockout.
...
- `pnpm check`: passed.
- `pnpm test:e2e`: passed, 8 browser flows.
